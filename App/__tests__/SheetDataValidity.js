/*
Test cases to check if data is not corrupted by firebase/sheetsApi call
*/
...
import CreateSpreadsheet from '../Sheets/CreateSheet';
import AddDataToSheet  from '../Sheets/AddDataToSheet';
import AppendData from '../Sheets/AppendData';
              ...
              <ScrollView>
                <View style={[{paddingRight: 10, paddingLeft: 10}]}>
                  ...
                  <View
                    ...
                    <CreateSpreadsheet />
                    <AddDataToSheet />
                    <AppendData timeStamp={this.state.date} time={this.state.time} quizNumber = {this.state.quizNumber}/>
                  </View>
                </View>
              </ScrollView>
            )
